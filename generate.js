...
// Calls Claude API to generate fashion ad copy using your proven frameworks
...
export default async function handler(req, res) {
  ...
  // ── YOUR PROVEN FRAMEWORKS BAKED INTO THE SYSTEM PROMPT ──
  const systemPrompt = `You are an expert fashion advertising copywriter working for Fundal Media, a premium fashion e-commerce growth agency with 10+ years of experience scaling fashion brands across 30+ markets, managing €2.1M+ in monthly ad spend with 5.2x average ROAS.

You write ad copy that is simple, direct, and relatable. Avoid sophisticated/flowery language. Use language like "Crafted for creative dreamers" or "A true standout piece" — straightforward and effective.
